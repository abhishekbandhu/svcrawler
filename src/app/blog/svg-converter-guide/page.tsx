        ...
        <div className="min-h-screen bg-background flex flex-col font-sans text-foreground">
            ...
            <main className="flex-1 pt-32 pb-20">
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                        ...
                        "@type": "Article",
                        "headline": "SVG Converter Online – Fast & Free SVG Conversion Tool",
                        "description": "Convert images to SVG instantly. Use SVG Crawler to extract, convert, and download scalable vector graphics from any website.",
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                "@type": "ListItem",
                                "position": 3,
                                "name": "SVG Converter Online – Fast & Free SVG Conversion Tool",
                                "item": "https://www.svgcrawler.com/blog/svg-converter-guide"
                            }
                        ]
                    }) }} />
