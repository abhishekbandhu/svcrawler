        ...
        <div className="min-h-screen bg-background flex flex-col font-sans text-foreground">
            ...
            <main className="flex-1 pt-32 pb-20">
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                        ...
                        "@type": "Article",
                        "headline": "Image to SVG Converter – Fast Vector Conversion Tool",
                        "description": "Transform any image into SVG format. Upload, convert, and download scalable vector graphics instantly.",
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                "@type": "ListItem",
                                "position": 3,
                                "name": "Image to SVG Converter – Fast Vector Conversion Tool",
                                "item": "https://www.svgcrawler.com/blog/image-to-svg-workflow"
                            }
                        ]
                    }) }} />
