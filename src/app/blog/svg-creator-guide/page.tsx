        ...
        <div className="min-h-screen bg-background flex flex-col font-sans text-foreground">
            ...
            <main className="flex-1 pt-32 pb-20">
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                        ...
                        "@type": "Article",
                        "headline": "SVG Creator Online – Create & Export SVG Files",
                        "description": "Create, extract, and export SVG files easily. Use SVG Crawler to build scalable graphics for web and design.",
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                "@type": "ListItem",
                                "position": 3,
                                "name": "SVG Creator Online – Create & Export SVG Files",
                                "item": "https://www.svgcrawler.com/blog/svg-creator-guide"
                            }
                        ]
                    }) }} />
