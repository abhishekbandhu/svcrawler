                ...
                <div id="results" className="w-full mt-16 scroll-mt-20">
                    <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <button
                                onClick={downloadAll}
                                className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground hover:bg-secondary hover:text-secondary-foreground rounded-xl transition-colors font-medium shadow-sm hover:shadow"
                            >
